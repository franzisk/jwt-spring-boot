...
public class TokenUtil implements Serializable {
	...
	private Boolean ignoreTokenExpiration(String token) {
		// se precisar que algum token especifico seja ignorado
		return false;
	}
	...
	// Se o token já expirou ele não pode ser renovado
	public Boolean canTokenBeRefreshed(String token) {
		return (!isTokenExpired(token) || ignoreTokenExpiration(token));
	}

	// Renovar no token atual para não deixar perder a validade
	...
	// Validar o token com base nos detalhes do usuário
	...
	// Calcular a data/hora para expiração do token
